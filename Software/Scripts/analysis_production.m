...
LCOE.Australia = variable(0.0,0.0,0.0,'$AUD/Mt','Cost ($AUD/kg)','Australia Green Hydrogen Price');
LCOE.Australia.mc_x = var_in.mc_x;
LCOE.Australia.mc_r = cost;
LCOE.Australia.montecarlo_fit();
LCOE.Australia.plot_montecarlo();

LCOE.Japan = variable(Japan.LCOE.Factor * LCOE.Australia.CurrentValue,LCOE.Australia.Uncertainity,0.0,'$AUD/Mt','Cost ($AUD/kg)','Japan Green Hydrogen Price');
...
LCOE.Korea = variable(Korea.LCOE.Factor * LCOE.Australia.CurrentValue,LCOE.Australia.Uncertainity,0.0,'$AUD/Mt','Cost ($AUD/kg)','Korea Green Hydrogen Price');
...
LCOE.USA = variable(USA.LCOE.Factor * LCOE.Australia.CurrentValue,LCOE.Australia.Uncertainity,0.0,'$AUD/Mt','Cost ($AUD/kg)','USA Green Hydrogen Price');
...
LCOE.China = variable(China.LCOE.Factor * LCOE.Australia.CurrentValue,LCOE.Australia.Uncertainity,0.0,'$AUD/Mt','Cost ($AUD/kg)','China Green Hydrogen Price');
...
LCOE.Brazil = variable(Brazil.LCOE.Factor * LCOE.Australia.CurrentValue,LCOE.Australia.Uncertainity,0.0,'$AUD/Mt','Cost ($AUD/kg)','Brazil Green Hydrogen Price');
...
LCOE.Belgium = variable(Belgium.LCOE.Factor * LCOE.Australia.CurrentValue,LCOE.Australia.Uncertainity,0.0,'$AUD/Mt','Cost ($AUD/kg)','Belgium Green Hydrogen Price');
...
LCOE.SaudiArabia = variable(SaudiArabia.LCOE.Factor * LCOE.Australia.CurrentValue,LCOE.Australia.Uncertainity,0.0,'$AUD/Mt','Cost ($AUD/kg)','Saudi Arabia Green Hydrogen Price');
...
LCOE.Morocco = variable(Morocco.LCOE.Factor * LCOE.Australia.CurrentValue,LCOE.Australia.Uncertainity,0.0,'$AUD/Mt','Cost ($AUD/kg)','Morocco Arabia Green Hydrogen Price');
...
LCOE.Namibia = variable(Namibia.LCOE.Factor * LCOE.Australia.CurrentValue,LCOE.Australia.Uncertainity,0.0,'$AUD/Mt','Cost ($AUD/kg)','Namibia Arabia Green Hydrogen Price');
...
LCOE.Oceania = variable(0.0,0.0,0.0,'$AUD/Mt','Cost ($AUD/kg)','Oceania Green Hydrogen Price');
LCOE.Oceania.mc_x = var_in.mc_x;
LCOE.Oceania.mc_r = cost;
LCOE.Oceania.montecarlo_fit();
LCOE.Oceania.plot_montecarlo();

LCOE.Europe = variable(Europe.LCOE.Factor * LCOE.Oceania.CurrentValue,LCOE.Oceania.Uncertainity,0.0,'$AUD/Mt','Cost ($AUD/kg)','Europe Green Hydrogen Price');
...
LCOE.NorthAmerica = variable(NorthAmerica.LCOE.Factor * LCOE.Oceania.CurrentValue,LCOE.Oceania.Uncertainity,0.0,'$AUD/Mt','Cost ($AUD/kg)','North America Green Hydrogen Price');
...
LCOE.SouthAmerica = variable(SouthAmerica.LCOE.Factor * LCOE.Oceania.CurrentValue,LCOE.Oceania.Uncertainity,0.0,'$AUD/Mt','Cost ($AUD/kg)','South America Green Hydrogen Price');
...
LCOE.Asia = variable(Asia.LCOE.Factor * LCOE.Oceania.CurrentValue,LCOE.Oceania.Uncertainity,0.0,'$AUD/Mt','Cost ($AUD/kg)','Asia Green Hydrogen Price');
...
LCOE.Africa = variable(Africa.LCOE.Factor * LCOE.Oceania.CurrentValue,LCOE.Oceania.Uncertainity,0.0,'$AUD/Mt','Cost ($AUD/kg)','Africa Green Hydrogen Price');
